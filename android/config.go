...
func (c *config) JavaSourceOverlays() string {
	return String(c.productVariables.DarkMagic.Java_Source_Overlays)
}

func (c *config) JavaSourceOverlayModuleWhitelist() []string {
	return android.DarkMagicConfig.JavaSourceOverlayModuleWhitelist
}
...
func (c *deviceConfig) SpecificCameraParametersLibrary() string {
	return String(c.config.productVariables.DarkMagic.Specific_camera_parameter_library)
}
